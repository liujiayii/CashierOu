...
public class SpecialOffersDTO implements Serializable{
    ...
    public SpecialOffersDTO(BigInteger id, BigInteger shopId, Integer state, String name, Integer type,
            BigDecimal discount, String startTime, String endTime, Integer priority, Integer scope,
            List<BigInteger> ids, List<Regulation> regulations, List<BigInteger> activityIds) {
        super();
        this.id = id;
        this.shopId = shopId;
        this.state = state;
