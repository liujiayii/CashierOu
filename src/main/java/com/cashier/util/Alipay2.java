...
import java.util.*;
	...
	public class Alipay2 {
	    private static Log log = LogFactory.getLog(Alipay2.class);
...
*/
	    ...
	    // 测试当面付2.0支付
	    @RequestMapping("facepay.action")
	    public AlipayF2FPayResult test_trade_pay(String TradeNo,String totalMoney,String scanCode,String sub) {
	        ...
	        String totalAmount = totalMoney;

	        // (必填) 付款条码，用户支付宝钱包手机app点击“付款”产生的付款条码
	        String authCode = scanCode; // 条码示例，286648048691290423用户自己的支付宝付款码
	        ...
	        String body = sub+"共"+totalAmount+"元";
	        ...
	        //GoodsDetail goods1 = GoodsDetail.newInstance("goods_id001", "玉璟斋餐饮商品","1", );
	        // 创建好一个商品后添加至商品明细列表
	    ...
	    // 测试当面付2.0退款
	    public AlipayF2FRefundResult test_trade_refund(String tradeNo,String totalMoney) {
	        // (必填) 外部订单号，需要退款交易的商户外部订单号
	        String outTradeNo = tradeNo;

	        // (必填) 退款金额，该金额必须小于等于订单的支付金额，单位为元
	        String refundAmount = totalMoney;
	    ...
	    public void test_trade_precreate() {
	        ...
	        switch (result.getTradeStatus()) {
	            case SUCCESS:
	                ...
	                // 需要修改为运行机器上的路径
	                String filePath = String.format("C:/Users/Administrator/Desktop/qr-%s.png",
