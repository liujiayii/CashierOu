...
public class WXPay {
    ...
    private void checkWXPayConfig() throws Exception {
        ...
        if (WXPayConfig.AppID == null || WXPayConfig.AppID.trim().length() == 0) {
            throw new Exception("appid in config is empty");
        }
        if (WXPayConfig.MchID == null || WXPayConfig.MchID.trim().length() == 0) {
            throw new Exception("appid in config is empty");
        }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, WXPayConfig.Key, this.signType);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, WXPayConfig.Key, signType);
    }
