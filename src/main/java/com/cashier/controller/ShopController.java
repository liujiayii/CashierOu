...
public class ShopController {
	...
	@ResponseBody
	public Object insertShop(ShopUserPermissionDTO shopUserPermissionDTO,String ids){
		Map<String , Object> map = new HashMap<String , Object>();
		try {
